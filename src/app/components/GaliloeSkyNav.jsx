    ...
    <div className="bg-nav-bg shadow-[0px_7px_10.9px_0px_#0000002E] py-[1px]">
      <div className="max-w-[870px] container lg:pr-[69px] ">
        ...
        <div
          ...
          } flex  gap-3 md:gap-4 lg:gap-6 max-md:w-full max-md:h-full fixed max-sm:bg-dark-gray bg-nav-bg max-md:backdrop-blur-[20px] top-0 max-md:pt-[120px] justify-center items-center md:h-unset md:static md:bg-transparent z-[40] transition-all ease-linear flex-col md:flex-row duration-300 px-6 md:px-0 `}
        >
